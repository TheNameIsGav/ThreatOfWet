...
public class PlayerDash : StateMachineBehaviour
{
    ...
    {
        playerController.instance.GetComponent<AudioSource>().clip = playerController.instance.playerDash;
        playerController.instance.GetComponent<AudioSource>().loop = false;
