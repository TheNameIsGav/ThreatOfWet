...
public class PlayerRun : StateMachineBehaviour
{
    ...
    {
        playerController.instance.GetComponent<AudioSource>().clip = playerController.instance.playerRun;
        playerController.instance.GetComponent<AudioSource>().loop = true;
